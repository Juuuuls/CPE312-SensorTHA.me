...
const char* ssid = "CONVERGE_MGM";                //replace with our wifi ssid // CONVERGE_MGM // Juls
const char* password = "magnait_3695926";         //replace with your wifi password // magnait_3695926 // 00000000

const char* host = "script.google.com";
const char *GScriptId = "AKfycbwrkzplIaeLqSsUQjJxow04qrEFGHUPuQ-eLPT7S53B6feyph0_U10I8C-rxE8igacb"; // Replace with your own google script id
...
void loop() {
  ...
  int airqualityvalue = analogRead(air_quality);
  ...
  sheetairquality = String(airqualityvalue) + String(" PPM");
  ...
  payload = payload_base + "\"" + sheetTemp + "," + sheetHumid + ","   + sheetairquality + "\"}";
