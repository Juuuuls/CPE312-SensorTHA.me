#define BLYNK_TEMPLATE_ID "TMPL6r54MurPL"
#define BLYNK_TEMPLATE_NAME "SensorMonitor"
#define BLYNK_AUTH_TOKEN "gENtNj7cvXnN8FfrxfjhVjIYSafj9mD8"
...
const char* ssid = "Juls";                //replace with our wifi ssid // CONVERGE_MGM // Juls // to change
const char* password = "00000000";         //replace with your wifi password // magnait_3695926 // 00000000 // to change
const char* auth = "gENtNj7cvXnN8FfrxfjhVjIYSafj9mD8";
...
void loop() {
  ...
  if (currentMillis-previousMillis >= duration){
    ...
    Serial.println(t_ave); Serial.println("=========================");
